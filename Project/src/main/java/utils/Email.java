...
public class Email {
	...
	public static boolean sendEmaiQuenMatKhau(Customer customer) {
		// Properties : khai báo các thuộc tính
		Properties props = new Properties();
		props.put("mail.smtp.host", "smtp.gmail.com"); // SMTP HOST
		props.put("mail.smtp.port", "587"); // TLS 587 SSL 465
		...
		try {
            ...
            // Phần HTML của email
            MimeBodyPart htmlPart = new MimeBodyPart();
            String htmlContent = "<html><body><h4>Xin chào " + customer.getNameCustomer() + " </h4>" + "\r\n" + "<p> " + "Mật Khẩu của bạn là " + StringEncryption.decryptString(customer.getPassword()) + "." + "</p>" + "\r\n" + "Chúc bạn một ngày vui vẻ," +  " </body></html>";
            htmlPart.setContent(htmlContent, "text/HTML; charset=UTF-8");
...
//	
	public static boolean sendEmailXacNhanDonHang(Order order) {
		...
		try {
			...
			// Người nhận
			msg.setRecipients(Message.RecipientType.TO, InternetAddress.parse(order.getCustomerID().getEmail(), false));
	...
	public static void main(String[] args) {
		Customer cus = new Customer("hoangtu", "123321", "Tuấn", "03455778312", "leminhhieu.ltp2021@gmail.com", "HCM");
		sendEmaiQuenMatKhau(cus);
	}
