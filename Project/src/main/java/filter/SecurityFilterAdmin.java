 ...
 */
public class SecurityFilterAdmin extends HttpFilter implements Filter {
       
    /**
     * @see HttpFilter#HttpFilter()
     */
    public SecurityFilterAdmin() {
        super();
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
	    ...
	    boolean isLoggedIn = (session != null && customer != null && customer.isRole());
